    ...
    public partial class addedFinals : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2023, 5, 13, 0, 0, 0, 0, DateTimeKind.Local), 10, "Example", 1 },
                    { 2, 1, new DateTime(2023, 5, 13, 0, 0, 0, 0, DateTimeKind.Local), 10, "Example", 2 },
                    { 3, 2, new DateTime(2023, 5, 13, 0, 0, 0, 0, DateTimeKind.Local), 10, "Example", 1 }
                });
